...
//void leer_input(input_manager *input, ALLEGRO_EVENT ev);
...
game_state N_mapa(game_state *game);
game_state juego(game_state *game,ALLEGRO_EVENT_QUEUE *queue,input_manager *teclado);
